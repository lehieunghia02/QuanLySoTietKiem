...
namespace QuanLySoTietKiem.Migrations
{
    ...
    [Migration("20251121140930_SeederDataLoaiSoTietKiemTable")]
    partial class SeederDataLoaiSoTietKiemTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLySoTietKiem.Entity.ChatHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuanLySoTietKiem.Entity.PaymentHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuanLySoTietKiem.Entity.SavingAccount", b =>
                {
                    b.Property<int>("MaSoTietKiem")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuanLySoTietKiem.Entity.TransactionType", b =>
                {
                    b.Property<int>("MaLoaiGiaoDich")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuanLySoTietKiem.Entity.GiaoDich", b =>
                {
                    b.HasOne("QuanLySoTietKiem.Entity.TransactionType", "LoaiGiaoDichNavigation")
                        .WithMany("GiaoDichs")
                        .HasForeignKey("MaLoaiGiaoDich")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QuanLySoTietKiem.Entity.SavingAccount", "SoTietKiem")
                        .WithMany("GiaoDichs")
